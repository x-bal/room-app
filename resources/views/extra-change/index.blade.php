...
<div class="panel panel-inverse">
    ...
    <div class="panel-body">
        <a href="#modal-dialog" id="btn-add" class="btn btn-primary mb-3" data-route="{{ route('extra-change.store') }}" data-bs-toggle="modal"><i class="ion-ios-add"></i> Add Extra Change</a>
